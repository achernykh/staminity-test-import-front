export const _translateMessage = {
	...
	ru: {
		...
		storageServiceErrorWithSignin: {
			title: '',
			text: 'Не удалось сохранить сессию пользователя.\nМы работает над этой ошибкой.\nПожалуйста, сообщите детали в поддержку {{e}}'
		},
        ...
        forbidden_need_signUp: {
            title: 'Ошибка',
            text: "Аккаунт отсутствует в Staminity. Пожалуйста зарегистрируйтесь"
        },
        databaseError: {
            title: 'Ошибка',
