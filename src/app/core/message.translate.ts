export const _translateMessage = {
	...
	ru: {
		...
		unconfirmedEmailAddress: {
			title: 'Ошибка!',
			text: 'Регистрация невозможна, ваш e-mail недоступен. Откройте доступ к e-mail или выберите другой способ входа в сервис'
		},
		userCancelOAuth: {
			title: '',
		...
		forbidden_CoachHasAthletesInThisClub: { // ошибка, если отключается роль "Тренер" у тренера, у которого в клубе есть спортсмены
			title: "Ошибка!",
