...
class DashboardActivityCtrl {
    ...
    $onInit() {
        ...
        //console.log('DashboardActivityCtrl $onInit, summaryAvg=', this.data.summaryAvg)
        /**
        ...
        if (this.structured) {
            ...
            if (this.segmentList.length > 4) {
                ...
                //console.log('DashboardItem: $onInit',this.segmentList, this.calculateSegmentListSize(this.segmentList));
            }
        }
    ...
    $onChange(changes) {
        ...
        if (changes.selected) {
            console.log('DashboardActivityCtrl: onChange, selected=', changes.selected);
        }
    ...
    onDelete() {
        "use strict";
        console.log('DashboardActivity: onDelete ', this.item);
...
DashboardActivityCtrl.$inject = ['$mdDialog','ActivityService'];
...
export let DashboardActivity = {
    ...
    template: require('./dashboard-activity.component.html')
};
