    ...
    ru: {
        settings: {
            ...
            agent: {
                ...
                inn: "ИНН",
                kpp: "КПП",
                notIndividualMessage: `Чтобы продавать тренировочные планы от имени юридического лица необходимо заполнить форму (ссылка) акцепта с условиями договора-оферты (ссылка), подписать и направить скан по адресу: .... <br/>
