    ...
    ru: {
        settings: {
            ...
            agent: {
                ...
                noResidentRUS: 'Для нерезидентов РФ временно разрешена публикация только бесплатных планов. Напишите нам, если заинтересованы в публикации платных планов: <a href="mailto:support@staminity.com">support@staminity.com</a>',
    ...
    en: {
        settings: {
            ...
            agent: {
                ...
                noResidentRUS: 'Training plan publication for non-Russian residents is available only for FREE plans. Let us know if you are interested in paid plan publication by e-mail at <a href="mailto:support@staminity.com">support@staminity.com</a>',
