        ...
        settings: {
            ...
            agent: {
                ...
                balance: {
                    ...
                    withdrawWithCommission: "Комиссия за вывод до {{noCommissionLimit}} {{currency}} - 2.8%",
                    withdrawNoCommission: "Вывести без комиссии",
                    withdrawConfirmationHeader: "Вы уверены?",
                    withdrawWithCommissionConfirmation: "Вывести с комиссией",
                    withdrawNoCommissionConfirmation: "Вывести без комиссии",
                },
