export const _translate = {
    ru: {
        ...
        personalInfo: {
            ...
            coachProfileIncomplete: 'Профиль тренера не заполнен <br> Вам необходимо ввести значения ...<br> Пока профиль тренера не заполнен, вы имеете следующие ограничения:<li>Первое</li><li>Второе</li>',
            main: {
                header: 'О себе',
                firstName: 'Имя',
                lastName: 'Фамилия',
