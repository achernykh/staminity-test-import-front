export const _translate = {
    ru: {
        ...
        personalInfo: {
            ...
            calendar: {
                title: 'Календарь',
                hint: 'Подсказака про интеграцию и как настроить',
                empty: 'Не удалось сегнерировать ссылку для подключения к календарю. Обратитесь пожалуйста <a href="">в поддержку</a>'
            }
        },
        privacy: {
            header: 'Приватность',
