export let _translate = {
	ru: {
		...
		tariffs: {
			...
			description: {
				basic: 'Ведите дневник тренировок, занимайтесь с тренером, общайтесь с друзьями',
				premium: 'Тариф "Базовый" + Планирование и детальный анализ',
			...
			functions: {
				...
				func5: '(CКОРО) Общение с друзьями, соревнования в группах',
				func6: '<b>Все функции по тарифу "Базовый"</b>',
				...
				func10: '+ (СКОРО) Отчетность и анализ по процессу тренировок',
				...
				func16: '+ (СКОРО) Отчетность и анализ по процессу тренировок учеников',
				func17: '+ (СКОРО) Тренировочные планы',
				func18: '<b>Функции тренера в рамках клуба</b>',
				...
				func23: '+ (СКОРО) Отчетность и анализ тренировочного процесса клуба',
				func24: '+ (СКОРО) Тренировочные планы клуба'
			},
            byMonth: '/месяц',
			byYear: '/год',

			coachAthletes: '{{minAthletes}} ученик для тренера - бесплатно. \n' +
			'{{athlete | currency}}/мес за дополнительных учеников. \n' +
			'Оплачивается не более {{maxAthletes}} учеников, с {{maxAthletes + 1}} - бесплатно',

			clubAthletes: '{{minAthletes}} ученик для каждого тренера клуба - бесплатно. \n' +
			'{{athlete | currency}}/мес за дополнительных учеников клуба. \n' +
			'Оплачивается не более {{maxAthletes + 1}} учеников на каждого тренера',

			clubCoaches: '{{minCoaches}} тренер входит в стоимость. \n' +
			'{{coach | currency}}/мес за каждого нового тренера клуба',

			calc: {
				params: 'Параметры',
				totals: 'Итого',
				subscription: 'Абоненсткая плата:',
				variable: 'Переменная часть:',
				premium: 'Хочу вести план для своих тренировок',
				coaches: 'Количество тренеров:',
				athletes: 'Количество атлетов:',
				proAthletes: 'Количество атлетов с тарифом Премиум:',
				freeAthletes: 'Более {{athletes}} атлетов бесплатно'
			}
		}
