	...
	ru: {
		...
		tariffs: {
			...
			description: {
				...
				premium: 'Базовый + <br/>' +
				'План и детальный анализ для своих тренировок',
			...
			coachAthletes: '1 ученик для тренера - бесплатно <br/>' +
			'210 RUB/мес за дополнительных учеников' +
			'Оплачивается не более 10 учеников, с 11 - бесплатно',

			clubAthletes: '1 ученик для каждого тренера клуба - бесплатно <br/>' +
			'210 RUB/мес за дополнительных учеников клуба <br/>' +
			'Оплачивается не более 10 учеников на каждого тренера',

			clubCoaches: '1 тренер входит в стоимость <br/>' +
			'300 RUB/мес за каждого нового тренера клуба'
		}
