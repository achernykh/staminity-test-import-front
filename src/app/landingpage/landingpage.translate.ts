export let _translate = {
	ru: {
		...
		start: {
			action: 'Старт',
			note: 'Дополнительный текст к старту'
		},
		devices: {
			...
			desktop: {
				...
				description: 'Открытое тестирование веб-версии приложения. Доступно в браузерех...'
			},
			mobile: {
				title: 'С вашего телефона',
				description: 'Мобильные приложения в разработке, вы можете использовать приложение через ваш мобильный браузер'
			}
		},
		scheme: {
