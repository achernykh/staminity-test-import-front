	...
	ru: {
		...
		footer: {
			block1 : {
				...
				link3: '<a flex href="https://staminity.com#coaches" class="md-body md-light">Для тренеров</a>',
				link4: '<a flex href="https://staminity.com#clubs" class="md-body md-light">Для клубов</a>',
