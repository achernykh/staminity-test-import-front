...
/* ---------- Принятие и отклонение запросов пользователей в группы --------**/
    ...
    /* ClubMembers **/
        ...
        /* Клуб получил запрос на выход из клуба от пользователя. Получатель уведомления - администраторы, отправитель - пользователь**/
...
//    ----------------- ENGLISH ---------------------
    ...
    en: {
        ...
        /* Клуб получил запрос на выход из клуба от пользователя. Получатель уведомления - администраторы, отправитель - пользователь**/
        requestLeaveClubMembers: "You've received a new leave club request",
