export let translateDialogs = {
    ru: {
        ...
        deleteActualActivity: 'Удалить соревнование? Будут удалены все связанные фактические тренировки и они не будут импортированы при последующей загрузке данных. Отменить операцию невозможно.',
