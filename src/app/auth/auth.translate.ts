export let _translate = {
	ru: {
		...
		confirmation: "Регистрируясь, Вы принимаете условия <a href='https://legal.staminity.com/ru/license.html'>Публичной оферты</a> и соглашаетесь с <a href='https://legal.staminity.com/ru/terms.html'>Условиями использования</a> сервиса.<br>",
