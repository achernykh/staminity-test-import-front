export let _translate = {
	ru: {
		...
		confirmation: "Регистрируясь, Вы принимаете условия Публичной оферты и соглашаетесь с Условиями использования сервиса.<br>"+
		"Ссылки: <a href='https://legal.staminity.com/ru/terms.html'>Публичная оферта</a>, "+
		"<a href='https://legal.staminity.com/ru/terms.html'>Условия использования</a>",
