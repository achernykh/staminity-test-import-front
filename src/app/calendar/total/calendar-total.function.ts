...
export const calculateCalendarTotals = (items: ICalendarDay[]): ICalendarWeekTotal => {
    ...
    const totalTemplate: ICalendarWeekSummary = {fact: {distance: 0, movingDuration: 0}, plan: {distance: 0, movingDuration: 0}};
    const primarySport = ["run", "bike", "swim"];
...
export const calculateCalendarSummary = (total: any): ICalendarWeekSummary => {
    ...
    const summary: ICalendarWeekSummary = {fact: {distance: 0, movingDuration: 0}, plan: {distance: 0, movingDuration: 0}};
